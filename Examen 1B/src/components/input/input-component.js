...
export class InputComponent {
  ...
  /**
   * Per-frame update hook. Subclasses with dynamic input state (keyboard
   * polling, bot AI, ...) override this; the default implementation is a
   * no-op for components whose state never changes after construction.
   * @returns {void}
   */
  update() {
    //
