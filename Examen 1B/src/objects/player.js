...
import { EightDirectionalMovementComponent } from '../components/movement/eight-directional-movement-component.js';
...
export class Player extends Phaser.GameObjects.Container {
  ...
  #weaponComponent;
  /** @type {EightDirectionalMovementComponent} */
  #movementComponent;
  ...
  constructor(scene, eventBusComponent) {
    ...
    this.#movementComponent = new EightDirectionalMovementComponent(
      this,
